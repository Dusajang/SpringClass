...
public class CustomerController {
   ...
   public String noticeReg (NoticeVO notice, HttpServletRequest request, Principal principal) throws ClassNotFoundException, SQLException, IllegalStateException, IOException {
      ...
      */
      ...
      //[2]
      notice.setWriter(principal.getName()); // 매개변수에 Principal principal 사용
      
      // 2.
      // int rowCount = this.noticeDao.insert(notice);
      
      int rowCount = 1;
      //this.noticeDao.insertAndPointUpOfMember(notice, "doodda77");
      //this.memberShipService.insertAndPointUpOfMember(notice, "doodda77");
